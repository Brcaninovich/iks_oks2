...
import com.brcaninovich.iks_okss.databinding.ActivityBotBinding;
...
public class gameplay {
    ...
    public static String pobjeda_bot(ActivityBotBinding binding){
        String line = null;
        for(int i = 1; i < 9; i++){
            switch (i){
                case 1:
    ...
    public static void winner_bot(ActivityBotBinding binding, int broj){
        if(broj == 1){
    ...
    public static void Bot_Play(ActivityBotBinding binding){
